...
{{-- Page title --}}
@section('title'){{ $title = trans('dhcd-art::language.titles.demo.update') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                {!! Form::model($demo, ['url' => route('dhcd.art.demo.update'), 'method' => 'put', 'class' => 'bf', 'files'=> true]) !!}
                <div class="row">
                    <div class="col-sm-8">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <a href="{!! route('dhcd.art.demo.create') !!}"
                               class="btn btn-danger">{{ trans('dhcd-art::language.buttons.discard') }}</a>
                        </div>
                    </div>
                    <!-- /.col-sm-4 --> </div>
                <!-- /.row -->
