...
{{-- Page title --}}
@section('title'){{ $title = trans('dhcd-art::language.titles.demo.manage') }}@stop
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('dhcd.art.demo.create') }}" class="btn btn-sm btn-default"><span
                                    class="glyphicon glyphicon-plus"></span> {{ trans('dhcd-art::language.buttons.create') }}</a>
                    </div>
                </div>
                <br/>
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            <thead>
                            <tr class="filters">
                                <th class="fit-content">{{ trans('dhcd-art::language.table.id') }}</th>
                                <th>{{ trans('dhcd-art::language.table.demo.name') }}</th>
                                <th style="width: 120px">{{ trans('dhcd-art::language.table.created_at') }}</th>
                                <th style="width: 120px">{{ trans('dhcd-art::language.table.updated_at') }}</th>
