...
{{-- Page title --}}
@section('title'){{ $title = trans('dhcd-administration::language.titles.country_district.manage') }}@stop
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        @if ($USER_LOGGED->canAccess('dhcd.administration.country-district.create'))
                            <a href="{{ route('dhcd.administration.country-district.create') }}" class="btn btn-sm btn-default"><span
