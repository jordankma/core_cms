...
@section('footer_scripts')
    ...
    {{-- <script src="{{ asset('/vendor/' . $group_name . '/' . $skin .'/js/pages/demo.js')}}" type="text/javascript"></script> --}}
    {{-- <script src="{{ asset('/vendor/' . $group_name . '/' . $skin .'/js/pages/demo-mock.js')}}" type="text/javascript"></script> --}}
