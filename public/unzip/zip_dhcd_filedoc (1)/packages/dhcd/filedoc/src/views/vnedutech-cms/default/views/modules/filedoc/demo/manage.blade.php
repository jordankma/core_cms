...
{{-- Page title --}}
@section('title'){{ $title = trans('dhcd-filedoc::language.titles.demo.manage') }}@stop
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('dhcd.filedoc.demo.create') }}" class="btn btn-sm btn-default"><span
                                    class="glyphicon glyphicon-plus"></span> {{ trans('dhcd-filedoc::language.buttons.create') }}</a>
                    </div>
                </div>
                <br/>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th>{{ trans('dhcd-filedoc::language.table.demo.name') }}</th>
                                <th style="width: 120px">{{ trans('dhcd-filedoc::language.table.created_at') }}</th>
                                <th style="width: 120px">{{ trans('dhcd-filedoc::language.table.updated_at') }}</th>
                                <th>{{ trans('dhcd-filedoc::language.table.action') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('dhcd.filedoc.demo.data') }}',
                columns: [
